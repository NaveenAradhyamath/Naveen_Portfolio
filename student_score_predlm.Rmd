1---
title: Predicting the percentage of an student based on the no.of study hours using linear regression model in R
author: "Naveen.A"
date: "03/02/2021"
output:
...
#We can see that there is 97.5% probability that the true unknown value of the coefficient will fall within the specified range.and the intercept falls between the range ( -2.75 to 7.720 ) that is the score if a student studies for 0 hours. and the hours falls between the range (8.83 - 10.71) that means there will be increase in score between 8.83 - 10.71 if the average of hour increases by 1 hour.
```
